...
class VCLGenerator extends \Magento\PageCache\Model\Varnish\VclGenerator
{
    ...
    public function getVariables(): array
    {
        return [
            ...
            'enable_bfcache' => (int) $this->varnishExtendedConfig->getEnableBfcache(),
            'enable_media_cache' => (int) $this->varnishExtendedConfig->getEnableMediaCache(),
            'enable_static_cache' => (int) $this->varnishExtendedConfig->getEnableStaticCache(),
